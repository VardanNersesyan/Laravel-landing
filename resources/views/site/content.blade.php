                ...
                @if(isset($portfolios) && is_object($portfolios))
                    ...
                    @foreach($portfolios as $item)
                        <div style="position: absolute; left: 0px; top: 0px; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1); width: 337px; opacity: 1;" class="portfolio-item one-four   {{ $item->filter }} isotope-item">
                            <div class="portfolio_img"> {!! Html::image('assets/img/'.$item->images,'',['alt'=>'Portfolio 1']) !!} </div>
...
<footer class="footer_wrapper" id="contact">
    ...
    <div class="container">
        <div class="footer_bottom"><span>Copyright © {{date('Y')}},    Created by <a href="#">Vardan</a>. </span> </div>
    </div>
</footer>